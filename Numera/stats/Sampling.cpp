...
std::vector<double> nr::Sampling::simple_random(const nr::VectorData<double>& data, size_t sampleSize)
{
    if (sampleSize == 0 || data.empty()) return {};
...
std::vector<double> nr::Sampling::systematic(const nr::VectorData<double>& data, size_t sample)
{
    if (data.empty() || sample == 0) return {};
...
std::vector<double> nr::Sampling::stratified(const nr::VectorData<double> &data, const std::vector<size_t> &strataLabels, size_t sampleSize)
{
    if (data.empty() || strataLabels.size() != data.size() || sampleSize == 0) return {};
...
std::vector<double> nr::Sampling::simple_random(const nr::CSVDataStore<std::string, double> &data, size_t sampleSize)
{
    if (sampleSize == 0 || data.empty()) return {};
...
std::vector<double> nr::Sampling::systematic(const nr::CSVDataStore<std::string, double> &data, size_t sample)
{
    if (data.empty() || sample == 0) return {};
...
std::vector<double> nr::Sampling::stratified(const nr::CSVDataStore<std::string, double> &data, size_t sampleSize)
{
